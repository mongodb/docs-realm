                    ...
                    Realm.getInstanceAsync(config, object : Realm.Callback() {
                        override fun onSuccess(realm: Realm) {
                            ...
                            realm.executeTransaction { r : Realm ->
                                ...
                                val hatchlings = r.where(Turtle::class.java).lessThan("age", 2).findAll()
                    ...
                    Realm.getInstanceAsync(config, object : Realm.Callback() {
                        override fun onSuccess(realm: Realm) {
                            ...
                            realm.executeTransaction { r : Realm ->
                                ...
                                val turtleEnthusiast = r.createObject(TurtleEnthusiast::class.java, primaryKeyValue)
                                // :hide-start:
                                expectation.fulfill()
                                // :hide-end:
                            }
                    ...
                    Realm.getInstanceAsync(config, object : Realm.Callback() {
                        override fun onSuccess(realm: Realm) {
                            ...
                            realm.executeTransaction { r : Realm ->
                                ...
                                val josephine = realm.createObject(TurtleEnthusiast::class.java, ObjectId())
