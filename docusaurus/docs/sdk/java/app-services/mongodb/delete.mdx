...
[`collection.deleteOne()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/mongo/MongoCollection.html#deleteOne-Bson-).
...
[`collection.deleteMany()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/mongo/MongoCollection.html#deleteMany-Bson-).
