...
see [API Key Authentication](https://docs.mongodb.com/realm/authentication/api-key/#std-label-api-key-authentication).
:::

## Create a User API Key

To create a new user API key, call [`user.ApiKeyAuth.create()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#create-java.lang.String-)
or [`user.ApiKeyAuth.createAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#createAsync-java.lang.String-io.realm.mongodb.App.Callback-)
...
call [`user.ApiKeyAuth.fetchAll()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#fetchAll--):
...
key's id to [`user.ApiKeyAuth.fetch()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#fetch-ObjectId-)
or [`user.ApiKeyAuth.fetchAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#fetchAsync-ObjectId-io.realm.mongodb.App.Callback->):
...
key's id to [`user.ApiKeyAuth.disable()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#disable-ObjectId-)
or [`user.ApiKeyAuth.disableAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#disableAsync-ObjectId-io.realm.mongodb.App.Callback-):
...
key's id to [`user.ApiKeyAuth.enable()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#enable-ObjectId-)
or [`user.ApiKeyAuth.enableAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#enableAsync-ObjectId-io.realm.mongodb.App.Callback-):
...
key's id to [`user.ApiKeyAuth.delete()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#delete-ObjectId-)
or [`user.ApiKeyAuth.deleteAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/ApiKeyAuth.html#deleteAsync-ObjectId-io.realm.mongodb.App.Callback-):
