...
The [API Key authentication provider](https://docs.mongodb.com/realm/authentication/api-key/)
...
The [Custom JWT authentication provider](https://docs.mongodb.com/realm/authentication/custom-jwt/)
...
The [Custom Function authentication provider](https://docs.mongodb.com/realm/authentication/custom-function/)
...
[`Credentials.customFunction()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/Credentials.html#customFunction-Document-).
...
The [Facebook authentication provider](https://docs.mongodb.com/realm/authentication/facebook/) allows
...
The [Google authentication provider](https://docs.mongodb.com/realm/authentication/google/)
...
1. Create a Realm `Credentials` object with [`Credentials.google()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/Credentials.html#google-java.lang.String-io.realm.mongodb.auth.GoogleAuthType-).
   Pass the ID token as the first parameter, and [`GoogleAuthType.ID_TOKEN`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/GoogleAuthType.html#ID_TOKEN) as the second parameter.

1. Use the [`app.login()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/App.html#login-io.realm.mongodb.Credentials-)
   or [`app.loginAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/App.html#loginAsync-io.realm.mongodb.Credentials-io.realm.mongodb.App.Callback-)
...
The [Sign-in with Apple authentication provider](https://docs.mongodb.com/realm/authentication/apple/)
