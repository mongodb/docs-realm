...
[`app.EmailPasswordAuth.registerUser()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html#registerUser-java.lang.String-java.lang.String-)
or [`app.EmailPasswordAuth.registerUserAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html#registerUserAsync-java.lang.String-java.lang.String-io.realm.mongodb.App.Callback-):
...
`tokenId` to [`app.EmailPasswordAuth.confirmUser()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html#confirmUser-java.lang.String-java.lang.String-)
or [`app.EmailPasswordAuth.confirmUserAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html#confirmUserAsync-java.lang.String-java.lang.String-io.realm.mongodb.App.Callback-):
...
[`app.EmailPasswordAuth.sendResetPasswordEmail()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html#sendResetPasswordEmail-java.lang.String-)
or [`app.EmailPasswordAuth.sendResetPasswordEmailAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html#sendResetPasswordEmailAsync-java.lang.String-io.realm.mongodb.App.Callback-):
...
[`app.EmailPasswordAuth`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html)
instance's [`resetPassword()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html#resetPassword-java.lang.String-java.lang.String-java.lang.String-)
or [`resetPasswordAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html#resetPasswordAsync-java.lang.String-java.lang.String-java.lang.String-io.realm.mongodb.App.Callback-)
methods:
...
define the Function that runs on the backend when you call [`app.EmailPasswordAuth.callResetPasswordFunction()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html#callResetPasswordFunction-java.lang.String-java.lang.String-java.lang.Object...-)
or [`app.EmailPasswordAuth.callResetPasswordFunctionAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/auth/EmailPasswordAuth.html#callResetPasswordFunctionAsync-java.lang.String-java.lang.String-java.lang.Object:A-io.realm.mongodb.App.Callback-)
...
of implementing custom flows, see: [Run a Password Reset Function](https://docs.mongodb.com/realm/authentication/email-password/#std-label-auth-run-a-password-reset-function).
:::
