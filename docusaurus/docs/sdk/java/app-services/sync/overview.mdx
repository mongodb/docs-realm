...
[`syncSession.stop()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SyncSession.html#stop--):
...
[`syncSession.start()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SyncSession.html#start--):
...
backend App. *Session state* refers to a single user's synchronization
...
To check the current network connection, call [`syncSession.getConnectionState()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SyncSession.html#getConnectionState--):
...
with [`syncSession.addConnectionChangeListener()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SyncSession.html#addConnectionChangeListener-io.realm.mongodb.sync.ConnectionListener-).

## Check Upload & Download Progress for a Sync Session

To subscribe to progress updates for uploads, call
[`syncSession.addUploadProgressListener()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SyncSession.html#addUploadProgressListener(io.realm.mongodb.sync.ProgressMode,io.realm.mongodb.sync.ProgressListener)).
...
To subscribe to progress updates for uploads, call [`syncSession.addDownloadProgressListener()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SyncSession.html#addDownloadProgressListener(io.realm.mongodb.sync.ProgressMode,io.realm.mongodb.sync.ProgressListener)).
...
`ErrorHandler` implementation to [`SyncConfiguration.Builder.errorHandler()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SyncConfiguration.Builder.html#errorHandler-io.realm.mongodb.sync.SyncSession.ErrorHandler-):
