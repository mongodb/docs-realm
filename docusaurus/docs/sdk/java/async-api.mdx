...
use a final parameter of type [`Realm.Callback`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.Callback.html).
...
When you query App Service features like [Functions](TODO)
and [user authentication](sdk/java/app-services/authenticate-users),
asynchronous calls accept a final
parameter of type [`App.Callback`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/App.Callback.html).
You can handle this callback with a lambda function that accepts a
single parameter of type [`App.Result`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/App.Result.html).
...
on a realm return an instance of [`RealmAsyncTask`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmAsyncTask.html).
You can optionally [specify an error handler](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.Transaction.OnError.html)
or a [success notification](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.Transaction.OnSuccess.html)
for `RealmAsyncTask` by passing additional parameters to the
asynchronous call. Additionally, use
[`cancel()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmAsyncTask.html#cancel--)
...
Asynchronous reads from a realm using [`findAllAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmQuery.html#findAllAsync--)
immediately return an empty
[`RealmResults`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmResults.html)
...
completes. You can register a listener with [`addChangeListener()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmResults.html#addChangeListener-io.realm.RealmChangeListener-)
...
[`RealmResultTask`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/RealmResultTask.html).
You can cancel `RealmResultTask` instances just like
`RealmAsyncTask`. To access the values returned by your query, you
can use:

- [`get()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/RealmResultTask.html#get--)
  to block until the operation completes

- [`getAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/RealmResultTask.html#getAsync-io.realm.mongodb.App.Callback-)
...
The SDK provides a set of [Kotlin extensions](https://docs.mongodb.com/realm-sdks/java/latest/kotlin-extensions/)
to request asynchronously using coroutines and flows instead of
callbacks. You can use these extensions to [execute transactions](https://docs.mongodb.com/realm-sdks/java/latest/kotlin-extensions/io.realm.kotlin/io.realm.-realm/execute-transaction-await.html),
[watch for changes](https://docs.mongodb.com/realm-sdks/java/latest/kotlin-extensions/io.realm.kotlin/add-change-listener.html),
[read](https://docs.mongodb.com/realm-sdks/java/latest/kotlin-extensions/io.realm.kotlin/io.realm.-realm/where.html),
and [write](https://docs.mongodb.com/realm-sdks/java/latest/kotlin-extensions/io.realm.kotlin/io.realm.-realm/create-object.html).
...
parameters for Realm Database [reads](https://docs.mongodb.com/realm-sdks/java/latest/kotlin-extensions/io.realm.kotlin/io.realm.-realm/where.html)
and
[writes](https://docs.mongodb.com/realm-sdks/java/latest/kotlin-extensions/io.realm.kotlin/io.realm.-realm/create-object.html)
easier.
:::
