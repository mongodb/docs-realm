...
.. literalinclude:: /examples/generated/java/sync/build.codeblock.realm-dependency.gradle
   :language: gradle
   :emphasize-lines: 10
   :copyable: false
...
.. literalinclude:: /examples/generated/java/sync/build.codeblock.livedata-dependency.gradle
   :language: gradle
   :emphasize-lines: 10
   :copyable: false
...
.. literalinclude:: /examples/generated/java/sync/build.codeblock.sync-enable.gradle
   :language: gradle
   :copyable: false
...
.. literalinclude:: /examples/generated/java/sync/build.codeblock.databinding-enable.gradle
   :language: gradle
...
- The ``onActive()`` method enables an observer to subscribe to changes
  ...
  .. literalinclude:: /examples/generated/java/sync/LiveRealmObject.codeblock.onactive.kt
     :language: kotlin
     :copyable: false
...
- The ``onInactive()`` method enables an observer to unsubscribe to
  ...
  .. literalinclude:: /examples/generated/java/sync/LiveRealmObject.codeblock.oninactive.kt
     :language: kotlin
     :copyable: false
...
- When a change occurs, the ``listener`` member uses the ``setValue()``
  ...
  .. literalinclude:: /examples/generated/java/sync/LiveRealmObject.codeblock.listener.kt
     :language: kotlin
     :copyable: false
...
.. literalinclude:: /examples/generated/java/sync/CounterModel.codeblock.constructor.kt
   :language: kotlin
...
.. literalinclude:: /examples/generated/java/sync/CounterFragment.codeblock.getcountermodel.kt
   :language: kotlin
   :copyable: false
...
.. literalinclude:: /examples/generated/java/sync/CounterFragment.codeblock.binding.kt
   :language: kotlin
   :copyable: false
