...
You can use [environments](https://docs.mongodb.com/realm/manage-apps/configure/config/environments/#std-label-appconfig-environment)
to manage separate apps for testing and production.

#### Testing Atlas Cluster

Applications that use Sync or [MongoDB queries](/sdk/java/app-services/query-mongodb)
