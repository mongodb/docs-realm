...
<Tabs groupId="java-sdk-languages">
    <TabItem value="kotlin" label="Kotlin">
        <CodeBlock title="Teacher.kt" language="kotlin">{TeacherKotlin}</CodeBlock>
        <CodeBlock title="Student.kt" language="kotlin">{StudentKotlin}</CodeBlock>
    </TabItem>
    <TabItem value="java" label="Java">
        <CodeBlock title="Teacher.java" language="java">{TeacherJava}</CodeBlock>
        <CodeBlock title="Student.java" language="java">{StudentJava}</CodeBlock>
    </TabItem>
</Tabs>
...
exposed by the
[`RealmQuery`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmQuery.html) class:
...
This gives you a new instance of the class [`RealmResults`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmResults.html),
containing teachers with the name "Ms. Langtree" or "Mrs. Jacobs".

`RealmQuery` includes several methods that can execute queries:

- [`findAll()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmQuery.html#findAll--)
  blocks until it finds all objects that meet the query conditions

- [`findAllAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmQuery.html#findAllAsync--)
  returns immediately and finds all objects that meet the query
  conditions asynchronously on a background thread

- [`findFirst()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmQuery.html#findFirst--)
  blocks until it finds the first object that meets the query conditions

- [`findFirstAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmQuery.html#findFirstAsync--)
...
[embedded objects](/sdk/java/realm-database/embedded-objects) and
[relationships](/sdk/java/realm-database/relationships)
with dot notation.
...
[`sort()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmQuery.html#sort-java.lang.String-):
...
using [`limit()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmQuery.html#limit-long-):
...
using [`distinct()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmQuery.html#distinct-java.lang.String-):
...
[`where()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmResults.html#where--):
...
Use [`realmQuery.rawPredicate()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmQuery.html#rawPredicate-java.lang.String-) to query
