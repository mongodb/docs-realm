...
[client maximum offline time](https://docs.mongodb.com/realm/sync/configure/optimize-sync-atlas-usage/#std-label-client-maximum-offline-time),
...
1. Use [`realm.writeCopyTo()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#writeCopyTo-java.io.File-)
...
application, you need to add code to use it. Use [`builder.assetFile()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmConfiguration.Builder.html#assetFile-java.lang.String-)
