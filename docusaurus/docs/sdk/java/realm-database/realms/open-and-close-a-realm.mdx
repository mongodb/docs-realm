...
[`RealmConfiguration`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmConfiguration.html) with
[`RealmConfiguration.Builder`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmConfiguration.Builder.html) and 
pass the resulting `RealmConfiguration` to
[`getInstance()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#getInstance-io.realm.RealmConfiguration-)
or [`getInstanceAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#getInstanceAsync-io.realm.RealmConfiguration-io.realm.Realm.Callback-):
...
It is important to remember to call [`close()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#close--)
...
[`RealmConfiguration`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmConfiguration.html) with a
[`RealmConfiguration.Builder`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmConfiguration.Builder.html).
...
the [`readOnly()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmConfiguration.Builder.html#readOnly--)
...
use [`inMemory()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmConfiguration.Builder.html#inMemory())
...
You can save any [`RealmConfiguration`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmConfiguration.html)
or [`SyncConfiguration`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SyncConfiguration.html)
as the default for your application using the
[`setDefaultConfiguration()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#setDefaultConfiguration-io.realm.RealmConfiguration-)
method:
...
You can then use
[`getDefaultConfiguration()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#getDefaultConfiguration--)
to access that configuration, or
[`getDefaultInstance()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#getDefaultInstance--)
