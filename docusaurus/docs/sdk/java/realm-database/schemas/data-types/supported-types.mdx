...
[`ignore`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/annotations/Ignore/)
...
`ObjectId` is a [MongoDB-specific 12-byte unique value](https://docs.mongodb.com/manual/reference/method/ObjectId/).
