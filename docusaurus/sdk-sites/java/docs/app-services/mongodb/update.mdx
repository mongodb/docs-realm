...
import UpdateKotlin from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.update-a-single-document.kt";
import UpdateJava from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.update-a-single-document.java";
import UpdateMultipleKotlin from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.update-multiple-documents.kt";
import UpdateMultipleJava from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.update-multiple-documents.java";
import UpsertKotlin from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.upsert-a-single-document.kt";
import UpsertJava from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.upsert-a-single-document.java";
