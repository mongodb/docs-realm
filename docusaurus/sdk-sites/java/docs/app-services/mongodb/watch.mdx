...
[watch](https://docs.mongodb.com/manual/reference/method/db.collection.watch/)
operations on a collection.

## Watch for Changes in a Collection

You can open a stream of changes made to a collection by calling
[`collection.watch()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/mongo/MongoCollection.html#watch--)
or [`collection.watchAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/mongo/MongoCollection.html#watchAsync--).
...
fulfill certain criteria by calling [`collection.watchWithFilter()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/mongo/MongoCollection.html#watchWithFilter-BsonDocument-)
or [`collection.watchWithFilterAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/mongo/MongoCollection.html#watchWithFilterAsync-Document-).
Both methods accept a `Document` or `BsonDocument` parameter that is
used as the query of a [`$match operator`](https://docs.mongodb.com/manual/reference/operator/aggregation/match/)
to process each [`database event`](https://docs.mongodb.com/realm/triggers/database-triggers/#std-label-database-events)
