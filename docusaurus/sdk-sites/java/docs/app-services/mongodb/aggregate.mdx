...
import FilterKotlin from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.aggregate-documents-filter.kt";
import FilterJava from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.aggregate-documents-filter.java";
import GroupKotlin from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.aggregate-documents-group.kt";
import GroupJava from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.aggregate-documents-group.java";
import ProjectKotlin from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.aggregate-documents-project.kt";
import ProjectJava from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.aggregate-documents-project.java";
import AddKotlin from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.aggregate-documents-addfields.kt";
import AddJava from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.aggregate-documents-addfields.java";
import UnwindKotlin from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.aggregate-documents-unwind-arrays.kt";
import UnwindJava from "!!raw-loader!@site/docs/generated/java/sync/MongoDBDataAccessTest.snippet.aggregate-documents-unwind-arrays.java";
