...
[`collection.aggregate()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/mongo/MongoCollection.html#aggregate-java.util.List-).
...
You can use the [`$match`](https://docs.mongodb.com/manual/reference/operator/aggregation/match/)
stage to filter documents according with a [query filter](https://docs.mongodb.com/manual/tutorial/query-documents/).
...
You can use the [`$group`](https://docs.mongodb.com/manual/reference/operator/aggregation/group/)
...
You can use the [`$project`](https://docs.mongodb.com/manual/reference/operator/aggregation/project/)
stage to include or omit specific fields from documents. Additionally,
you can calculate new fields using [aggregation operators](https://docs.mongodb.com/manual/reference/operator/aggregation/).
...
You can use the [`$addFields`](https://docs.mongodb.com/manual/reference/operator/aggregation/addFields/)
stage to add new fields with calculated values using [aggregation operators](https://docs.mongodb.com/manual/reference/operator/aggregation/).
...
You can use the [`$unwind`](https://docs.mongodb.com/manual/reference/operator/aggregation/unwind/)
