...
they are returned in an [indeterminate order](https://docs.mongodb.com/manual/reference/method/cursor.sort/#return-in-natural-order)
...
1. [Link a MongoDB data source](https://docs.mongodb.com/realm/mongodb/link-a-data-source/)
...
<Tabs groupId="java-sdk-languages">
    <TabItem value="kotlin" label="Kotlin">
        <CodeBlock title="Plant.kt" language="kotlin">{PlantKotlin}</CodeBlock>
        <CodeBlock title="Plant.kt" language="kotlin">{ExampleKotlin}</CodeBlock>
    </TabItem>
    <TabItem value="java" label="Java">
        <CodeBlock title="Plant.java" language="java">{PlantJava}</CodeBlock>
        <CodeBlock title="Plant.kt" language="kotlin">{ExampleKotlin}</CodeBlock>
    </TabItem>
</Tabs>
