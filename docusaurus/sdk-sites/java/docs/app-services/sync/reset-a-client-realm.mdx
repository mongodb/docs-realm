...
import DiscardKotlin from "!!raw-loader!@site/docs/generated/java/sync/ClientResetTest.snippet.client-reset-discard-unsynced-changes.kt";
import DiscardJava from "!!raw-loader!@site/docs/generated/java/sync/ClientResetTest.snippet.client-reset-discard-unsynced-changes.java";
import DiscardDestructKotlin from "!!raw-loader!@site/docs/generated/java/sync/ClientResetTest.snippet.client-reset-discard-unsynced-changes-with-simple-manual-fallback.kt";
import DiscardDestructJava from "!!raw-loader!@site/docs/generated/java/sync/ClientResetTest.snippet.client-reset-discard-unsynced-changes-with-simple-manual-fallback.java";
