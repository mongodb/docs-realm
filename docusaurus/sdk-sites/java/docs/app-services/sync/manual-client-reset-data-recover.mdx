...
import ManualKotlin from "!!raw-loader!@site/docs/generated/java/sync/ClientResetTest.snippet.client-reset-manually-recover-unsynced-changes.kt";
import ManualJava from "!!raw-loader!@site/docs/generated/java/sync/ClientResetTest.snippet.client-reset-manually-recover-unsynced-changes.java";
import PotatoKotlin from "!!raw-loader!@site/docs/generated/java/sync/Potato.snippet.potato-kotlin-definition.kt";
import PotatoJava from "!!raw-loader!@site/docs/generated/java/sync/PotatoJava.snippet.potato-java-definition.java";
import OnionKotlin from "!!raw-loader!@site/docs/generated/java/sync/Onion.snippet.onion-kotlin-definition.kt";
import OnionJava from "!!raw-loader!@site/docs/generated/java/sync/OnionJava.snippet.onion-java-definition.java";
import RiceKotlin from "!!raw-loader!@site/docs/generated/java/sync/Rice.snippet.rice-kotlin-definition.kt";
import RiceJava from "!!raw-loader!@site/docs/generated/java/sync/RiceJava.snippet.rice-java-definition.java";
import LastSyncedKotlin from "!!raw-loader!@site/docs/generated/java/sync/LastSynced.snippet.last-synced-kotlin-definition.kt";
import LastSyncedJava from "!!raw-loader!@site/docs/generated/java/sync/LastSyncedJava.snippet.last-synced-java-definition.java";
import TrackLastSyncedKotlin from "!!raw-loader!@site/docs/generated/java/sync/ClientResetTest.snippet.keep-track-of-last-synced-time.kt";
import TrackLastSyncedJava from "!!raw-loader!@site/docs/generated/java/sync/ClientResetTest.snippet.keep-track-of-last-synced-time.java";
import HandleManualKotlin from "!!raw-loader!@site/docs/generated/java/sync/ClientResetTest.snippet.handle-manual-reset.kt";
import HandleManualJava from "!!raw-loader!@site/docs/generated/java/sync/ClientResetTest.snippet.handle-manual-reset.java";
