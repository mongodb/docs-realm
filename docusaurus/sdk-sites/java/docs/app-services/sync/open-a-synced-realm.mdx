...
import ConfigureKotlin from "!!raw-loader!@site/docs/generated/java/sync/OpenARealmTest.snippet.configure-a-realm.kt";
import ConfigureJava from "!!raw-loader!@site/docs/generated/java/sync/OpenARealmTest.snippet.configure-a-realm.java";
import OpenKotlin from "!!raw-loader!@site/docs/generated/java/sync/OpenARealmTest.snippet.allow-reads-writes-ui-thread.kt";
import OpenJava from "!!raw-loader!@site/docs/generated/java/sync/OpenARealmTest.snippet.allow-reads-writes-ui-thread.java";
import FlexibleKotlin from "!!raw-loader!@site/docs/generated/java/sync/FlexibleSyncTest.snippet.open-a-realm.kt";
import FlexibleJava from "!!raw-loader!@site/docs/generated/java/sync/FlexibleSyncTest.snippet.open-a-realm.java";
...
You can also open a Atlas Device Synchronously by using [`Realm.getInstance()`](https://www.mongodb.com/docs/realm-sdks/java/latest/io/realm/Realm.html#getInstance-io.realm.RealmConfiguration-)
