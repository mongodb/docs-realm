...
- [Configure Flexible Sync on the backend](https://docs.mongodb.com/realm/sync/configure/enable-sync/#std-label-enable-flexible-sync)
...
[Flexible Sync Rules & Permissions](https://docs.mongodb.com/realm/sync/data-access-patterns/permissions/#std-label-flexible-sync-rules-and-permissions).
:::
...
Language. See [Flexible Sync RQL Limitations](https://docs.mongodb.com/realm/reference/realm-query-language/#std-label-flexible-sync-rql-limitations)
for details.
:::
...
synced realm. Use the [`waitForInitialRemoteData()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SyncConfiguration.Builder.html#waitForInitialRemoteData(long,java.util.concurrent.TimeUnit))
...
You can also use [`SubscriptionSet.waitForSynchronization()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SubscriptionSet.html#waitForSynchronization(java.lang.Long,java.util.concurrent.TimeUnit))
or [`SubscriptionSet.waitForSynchronizationAsync()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SubscriptionSet.html#waitForSynchronizationAsync(java.lang.Long,java.util.concurrent.TimeUnit,io.realm.mongodb.sync.SubscriptionSet.StateChangeCallback))
...
[`SubscriptionSet.State`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SubscriptionSet.State.html) enum.
...
[`SubscriptionSet.getState()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SubscriptionSet.html#getState()).
...
You can update subscriptions using [`SubscriptionSet.update()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/SubscriptionSet.html#update(io.realm.mongodb.sync.SubscriptionSet.UpdateCallback)).
In this example, we use [`MutableSubscriptionSet.addOrUpdate()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/MutableSubscriptionSet.html#addOrUpdate(io.realm.mongodb.sync.Subscription))
...
using [`MutableSubscriptionSet.remove()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/MutableSubscriptionSet.html#remove(io.realm.mongodb.sync.Subscription)).
...
a class to [`removeAll()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/MutableSubscriptionSet.html#removeAll(java.lang.Class)):
...
[`removeAll()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/mongodb/sync/MutableSubscriptionSet.html#removeAll())
with no arguments:
