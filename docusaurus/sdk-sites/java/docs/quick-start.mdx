...
import TaskJava from '!!raw-loader!@site/docs/generated/java/local/DefinitelyNotJavaTask.codeblock.define-object-model-local.java';
import TaskStatusJava from '!!raw-loader!@site/docs/generated/java/local/TaskStatus.codeblock.define-object-model-local.java';
import TaskAndTaskStatusKotlin from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.define-object-model-local.kt';
import OpenARealmJava from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.open-a-realm-local.java';
import OpenARealmKotlin from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.open-a-realm-local.kt';
import CreateJava from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.create-object-local.java';
import CreateKotlin from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.create-object-local.kt';
import ReadJava from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.read-object-local.java';
import ReadKotlin from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.read-object-local.kt';
import FilterJava from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.filter-collection-local.java';
import FilterKotlin from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.filter-collection-local.kt';
import UpdateJava from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.update-object-local.java';
import UpdateKotlin from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.update-object-local.kt';
import DeleteJava from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.delete-object-local.java';
import DeleteKotlin from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.delete-object-local.kt';
import WatchJava from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.watch-for-changes-local.java';
import WatchKotlin from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.watch-for-changes-local.kt';
import CompleteJava from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.complete.java';
import CompleteKotlin from '!!raw-loader!@site/docs/generated/java/local/MainActivity.codeblock.complete.kt';
