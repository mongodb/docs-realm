...
import PrimaryKeyKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogPrimaryKeyExampleKt.snippet.complete.kt";
import PrimaryKeyJava from "!!raw-loader!@site/docs/generated/java/local/FrogPrimaryKeyExample.snippet.complete.java";
import RequiredKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogRequiredExampleKt.snippet.complete.kt";
import RequiredJava from "!!raw-loader!@site/docs/generated/java/local/FrogRequiredExample.snippet.complete.java";
import IndexKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogIndexExampleKt.snippet.complete.kt";
import IndexJava from "!!raw-loader!@site/docs/generated/java/local/FrogIndexExample.snippet.complete.java";
import ModuleKotlin from "!!raw-loader!@site/docs/generated/java/local/OmitModuleExampleKt.snippet.complete.kt";
import ModuleJava from "!!raw-loader!@site/docs/generated/java/local/OmitModuleExample.snippet.complete.java";
import FrogObjectKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogObjectExampleKt.snippet.complete.kt";
import FrogObjectJava from "!!raw-loader!@site/docs/generated/java/local/FrogObjectExample.snippet.complete.java";
import FrogModelKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogRealmModelExampleKt.snippet.complete.kt";
import FrogModelJava from "!!raw-loader!@site/docs/generated/java/local/FrogRealmModelExample.snippet.complete.java";
import StaticDynamicCallsKotlin from "!!raw-loader!@site/docs/generated/java/local/RealmObjectVsRealmModelTest.snippet.realm-object-vs-realm-model.kt";
import StaticDynamicCallsJava from "!!raw-loader!@site/docs/generated/java/local/RealmObjectVsRealmModelTest.snippet.realm-object-vs-realm-model.java";
import DefaultKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogDefaultValueExampleKt.snippet.complete.kt";
import DefaultJava from "!!raw-loader!@site/docs/generated/java/local/FrogDefaultValueExample.snippet.complete.java";
import FrogRenameFieldKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogRenameAFieldExampleKt.snippet.complete.kt";
import FrogRenameFieldJava from "!!raw-loader!@site/docs/generated/java/local/FrogRenameAFieldExample.snippet.complete.java";
import RenameModuleKotlin from "!!raw-loader!@site/docs/generated/java/local/RenameModuleExampleKt.snippet.complete.kt";
import RenameModuleJava from "!!raw-loader!@site/docs/generated/java/local/RenameModuleExample.snippet.complete.java";
import FrogClassRenamePolicyKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogClassRenamePolicyExampleKt.snippet.complete.kt";
import FrogClassRenamePolicyJava from "!!raw-loader!@site/docs/generated/java/local/FrogClassRenamePolicyExample.snippet.complete.java";
import FrogRenameKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogRenameClassExampleKt.snippet.complete.kt";
import FrogRenameJava from "!!raw-loader!@site/docs/generated/java/local/FrogRenameClassExample.snippet.complete.java";
