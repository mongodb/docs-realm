...
[`realm.copyToRealm()`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/Realm/#copytorealm)
and [`realm.copyFromRealm()`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/Realm/#copyfromrealm).

### Define Realm Objects

To define a Realm object in your application,
create a subclass of [`RealmObject`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmObject.html)
or implement [`RealmModel`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmModel.html).
...
[`@PrimaryKey`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/annotations/PrimaryKey/)
...
- Primary key values must be unique across all instances of an object
  ...
  results in a [`RealmPrimaryKeyConstraintException`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/exceptions/RealmPrimaryKeyConstraintException/).
...
Mark a nullable field with the [`@Required`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/annotations/Required/)
...
[`@Index`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/annotations/Required/)
annotation:
...
Use the [`@RealmField`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/annotations/RealmField.html)
...
You can define a
[naming policy](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/annotations/RealmNamingPolicy.html)
...
Use the [`@RealmClass`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/annotations/RealmClass.html)
...
[`RealmModule`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/annotations/RealmModule/)
