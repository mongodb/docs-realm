...
import FrogSetKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogSetKt.snippet.complete.kt";
import SnackKotlin from "!!raw-loader!@site/docs/generated/java/local/SnackKt.snippet.complete.kt";
import UsageKotlin from "!!raw-loader!@site/docs/generated/java/local/DataTypesTest.snippet.realmSet.kt";
import FrogSetJava from "!!raw-loader!@site/docs/generated/java/local/FrogSet.snippet.complete.java";
import SnackJava from "!!raw-loader!@site/docs/generated/java/local/Snack.snippet.complete.java";
import UsageJava from "!!raw-loader!@site/docs/generated/java/local/DataTypesTest.snippet.realmSet.java";
import NotificationsJava from "!!raw-loader!@site/docs/generated/java/local/DataTypesTest.snippet.realmset-notifications.java";
import NotificationsKotlin from "!!raw-loader!@site/docs/generated/java/local/DataTypesTest.snippet.realmset-notifications.kt";
