...
import FrogAnyKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogAnyKt.snippet.complete.kt";
import UsageKotlin from "!!raw-loader!@site/docs/generated/java/local/DataTypesTest.snippet.realmany.kt";
import FrogAnyJava from "!!raw-loader!@site/docs/generated/java/local/FrogAny.snippet.complete.java";
import UsageJava from "!!raw-loader!@site/docs/generated/java/local/DataTypesTest.snippet.realmany.java";
import NotificationsJava from "!!raw-loader!@site/docs/generated/java/local/DataTypesTest.snippet.realmany-notifications.java";
import NotificationsKotlin from "!!raw-loader!@site/docs/generated/java/local/DataTypesTest.snippet.realmany-notifications.kt";
