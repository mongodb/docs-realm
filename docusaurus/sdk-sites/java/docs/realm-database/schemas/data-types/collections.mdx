...
import ListJava from "!!raw-loader!@site/docs/generated/java/local/FrogListExampleKt.snippet.complete.kt";
import ListKotlin from "!!raw-loader!@site/docs/generated/java/local/FrogListExample.snippet.complete.java";
import ItemJava from "!!raw-loader!@site/docs/generated/java/local/JavaItem.snippet.complete.java";
import ItemKotlin from "!!raw-loader!@site/docs/generated/java/local/Item.snippet.complete.kt";
import ExampleListAdapterJava from "!!raw-loader!@site/docs/generated/java/local/ExampleListAdapter.snippet.complete.java";
import ListAdapterUsageJava from "!!raw-loader!@site/docs/generated/java/local/AdapterTest.snippet.list-adapter.java";
import ExampleListAdapterKotlin from "!!raw-loader!@site/docs/generated/java/local/ExampleListAdapter.snippet.complete.kt";
import ListAdapterUsageKotlin from "!!raw-loader!@site/docs/generated/java/local/AdapterTest.snippet.list-adapter.kt";
import ExampleRecyclerViewAdapterJava from "!!raw-loader!@site/docs/generated/java/local/ExampleRecyclerViewAdapter.snippet.complete.java";
import RecyclerViewAdapterUsageJava from "!!raw-loader!@site/docs/generated/java/local/AdapterTest.snippet.recycler-view-adapter.java";
import ExampleRecyclerViewAdapterKotlin from "!!raw-loader!@site/docs/generated/java/local/ExampleRecyclerViewAdapter.snippet.complete.kt";
import RecyclerViewAdapterUsageKotlin from "!!raw-loader!@site/docs/generated/java/local/AdapterTest.snippet.recycler-view-adapter.kt";
