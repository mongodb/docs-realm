...
[`@Required`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/annotations/Required/) annotation.
:::
...
The [`RealmResults`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/RealmResults/)
...
interface, including [`RealmResults`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/RealmResults/)
and [`RealmList`](https://docs.mongodb.com/realm/sdk/java/api/io/realm/RealmList/).
