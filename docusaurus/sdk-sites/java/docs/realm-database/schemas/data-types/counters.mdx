...
import HauntedHouseKotlin from "!!raw-loader!@site/docs/generated/java/local/HauntedHouseKt.snippet.complete.kt";
import HauntedHouseJava from "!!raw-loader!@site/docs/generated/java/local/HauntedHouse.snippet.complete.java";
import IDKotlin from "!!raw-loader!@site/docs/generated/java/local/WritesTest.snippet.counter-increment-decrement.kt";
import IDJava from "!!raw-loader!@site/docs/generated/java/local/WritesTest.snippet.counter-increment-decrement.java";
import SetKotlin from "!!raw-loader!@site/docs/generated/java/local/WritesTest.snippet.counter-set.kt";
import SetJava from "!!raw-loader!@site/docs/generated/java/local/WritesTest.snippet.counter-set.java";
