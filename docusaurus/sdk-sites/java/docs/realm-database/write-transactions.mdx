...
import TransactionKotlin from "!!raw-loader!@site/docs/generated/java/sync/WritesTest.snippet.run-a-transaction.kt";
import TransactionJava from "!!raw-loader!@site/docs/generated/java/sync/WritesTest.snippet.run-a-transaction.java";
