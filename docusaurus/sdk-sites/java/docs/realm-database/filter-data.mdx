...
import TeacherKotlin from "!!raw-loader!@site/docs/generated/java/local/TeacherKt.snippet.complete.kt";
import StudentKotlin from "!!raw-loader!@site/docs/generated/java/local/StudentKt.snippet.complete.kt";
import TeacherJava from "!!raw-loader!@site/docs/generated/java/local/Teacher.snippet.complete.java";
import StudentJava from "!!raw-loader!@site/docs/generated/java/local/Student.snippet.complete.java";
import FiltersKotlin from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.filters.kt";
import FiltersJava from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.filters.java";
import LinkKotlin from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.link-queries.kt";
import LinkJava from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.link-queries.java";
import InverseKotlin from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.link-queries-inverse.kt";
import InverseJava from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.link-queries-inverse.java";
import SortKotlin from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.sort.kt";
import SortJava from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.sort.java";
import LimitKotlin from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.limit.kt";
import LimitJava from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.limit.java";
import UniqueKotlin from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.unique.kt";
import UniqueJava from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.unique.java";
import ChainKotlin from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.chain-queries.kt";
import ChainJava from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.chain-queries.java";
import RawKotlin from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.realm-query-language.kt";
import RawJava from "!!raw-loader!@site/docs/generated/java/local/FilterDataTest.snippet.realm-query-language.java";
