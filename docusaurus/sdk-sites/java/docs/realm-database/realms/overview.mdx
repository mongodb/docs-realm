...
- *You open a realm on a background thread and forget to close it
...
- *You hold references to too many versions of frozen objects.*
  ...
  objects, consider using [`realm.copyFromRealm()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#copyFromRealm-E-)
  instead to only preserve the data you need.

- *You read some data from a realm. Then, you block the thread with
   a long-running operation. Meanwhile, you write many times to the
   realm on other threads.* This causes the SDK to
...
- **Manually**: call [`compactRealm()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#compactRealm-io.realm.RealmConfiguration-).

- **Automatically**: specify the [`compactOnLaunch()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmConfiguration.Builder.html#compactOnLaunch-io.realm.CompactOnLaunchCallback-)
...
You can set [`maxNumberOfActiveVersions()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/RealmConfiguration.Builder.html#maxNumberOfActiveVersions-long-)
...
Alternatively, you can also use [`realm.writeCopyTo()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#writeCopyTo-java.io.File-)
