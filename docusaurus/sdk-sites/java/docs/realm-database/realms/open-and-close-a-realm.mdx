...
import OpenKotlin from "!!raw-loader!@site/docs/generated/java/local/OpenARealmTest.snippet.open-a-realm-local.kt";
import OpenJava from "!!raw-loader!@site/docs/generated/java/local/OpenARealmTest.snippet.open-a-realm-local.java";
import CloseKotlin from "!!raw-loader!@site/docs/generated/java/local/OpenARealmTest.snippet.close-a-realm-local.kt";
import CloseJava from "!!raw-loader!@site/docs/generated/java/local/OpenARealmTest.snippet.close-a-realm-local.java";
import ConfigureKotlin from "!!raw-loader!@site/docs/generated/java/local/OpenARealmTest.snippet.configure-a-realm-local.kt";
import ConfigureJava from "!!raw-loader!@site/docs/generated/java/local/OpenARealmTest.snippet.configure-a-realm-local.java";
import ReadOnlyKotlin from "!!raw-loader!@site/docs/generated/java/local/RealmTypesTest.snippet.read-only.kt";
import ReadOnlyJava from "!!raw-loader!@site/docs/generated/java/local/RealmTypesTest.snippet.read-only.java";
import InMemoryKotlin from "!!raw-loader!@site/docs/generated/java/local/RealmTypesTest.snippet.in-memory.kt";
import InMemoryJava from "!!raw-loader!@site/docs/generated/java/local/RealmTypesTest.snippet.in-memory.java";
import DynamicKotlin from "!!raw-loader!@site/docs/generated/java/local/RealmTypesTest.snippet.dynamic.kt";
import DynamicJava from "!!raw-loader!@site/docs/generated/java/local/RealmTypesTest.snippet.dynamic.java";
import SetDefaultKotlin from "!!raw-loader!@site/docs/generated/java/local/OpenARealmTest.snippet.set-default-realm.kt";
import SetDefaultJava from "!!raw-loader!@site/docs/generated/java/local/OpenARealmTest.snippet.set-default-realm.java";
import UseDefaultKotlin from "!!raw-loader!@site/docs/generated/java/local/OpenARealmTest.snippet.use-default-realm.kt";
import UseDefaultJava from "!!raw-loader!@site/docs/generated/java/local/OpenARealmTest.snippet.use-default-realm.java";
