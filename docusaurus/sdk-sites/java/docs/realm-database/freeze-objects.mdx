...
import FreezeKotlin from "!!raw-loader!@site/docs/generated/java/local/ThreadingTest.snippet.freeze-objects.kt";
import FreezeJava from "!!raw-loader!@site/docs/generated/java/local/ThreadingTest.snippet.freeze-objects.java";
