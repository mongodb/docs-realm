...
import SortKotlin from '!!raw-loader!@site/docs/generated/java/sync/ReadsTest.snippet.sort-results.kt';
import SortJava from '!!raw-loader!@site/docs/generated/java/sync/ReadsTest.snippet.sort-results.java';
