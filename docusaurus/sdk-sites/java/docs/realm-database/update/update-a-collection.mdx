...
import UpdateCollKotlin from "!!raw-loader!@site/docs/generated/java/sync/WritesTest.codeblock.update-a-collection.kt";
import UpdateCollJava from "!!raw-loader!@site/docs/generated/java/sync/WritesTest.codeblock.update-a-collection.java";
