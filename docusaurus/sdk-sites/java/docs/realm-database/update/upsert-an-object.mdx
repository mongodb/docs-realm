...
import UpsertKotlin from '!!raw-loader!@site/docs/generated/java/sync/WritesTest.codeblock.upsert-an-object.kt';
import UpsertJava from '!!raw-loader!@site/docs/generated/java/sync/WritesTest.codeblock.upsert-an-object.java';
import CopyOrUpdateKotlin from '!!raw-loader!@site/docs/generated/java/sync/WritesTest.codeblock.copy-or-update-same-values-flag.kt';
import CopyOrUpdateJava from '!!raw-loader!@site/docs/generated/java/sync/WritesTest.codeblock.copy-or-update-same-values-flag.java';
...
update their name to "Andy" using [`insertOrUpdate()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#insertOrUpdate-io.realm.RealmModel-):
...
You can also use [`copyToRealmOrUpdate()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/Realm.html#copyToRealmOrUpdate-E-io.realm.ImportFlag...-)
to either create a new object based on a supplied object or update an
existing object with the same primary key value. Use
[`ImportFlag.CHECK_SAME_VALUES_BEFORE_SET`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/ImportFlag.html#CHECK_SAME_VALUES_BEFORE_SET)
