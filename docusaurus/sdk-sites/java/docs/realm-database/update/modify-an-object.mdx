...
import UpdateKotlin from '!!raw-loader!@site/docs/generated/java/sync/WritesTest.codeblock.update-an-object.kt';
import UpdateJava from '!!raw-loader!@site/docs/generated/java/sync/WritesTest.codeblock.update-an-object.java';
