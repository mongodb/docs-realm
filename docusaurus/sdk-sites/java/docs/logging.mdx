...
[`LogLevel`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/log/LogLevel.html)
to [`RealmLog.setLevel()`](https://docs.mongodb.com/realm-sdks/java/latest/io/realm/log/RealmLog.html#setLevel-int-):
