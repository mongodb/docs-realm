...
import RealmDependency from "!!raw-loader!@site/docs/generated/java/sync/build.snippet.realm-dependency.gradle";
import LiveDataDependency from "!!raw-loader!@site/docs/generated/java/sync/build.snippet.livedata-dependency.gradle";
import SyncEnable from "!!raw-loader!@site/docs/generated/java/sync/build.snippet.sync-enable.gradle";
import DatabindingEnable from "!!raw-loader!@site/docs/generated/java/sync/build.snippet.databinding-enable.gradle";
import OnInactive from "!!raw-loader!@site/docs/generated/java/sync/LiveRealmObject.snippet.oninactive.kt";
import Listener from "!!raw-loader!@site/docs/generated/java/sync/LiveRealmObject.snippet.listener.kt";
import CounterModelConstructor from "!!raw-loader!@site/docs/generated/java/sync/CounterModel.snippet.constructor.kt";
import GetCounterModel from "!!raw-loader!@site/docs/generated/java/sync/CounterFragment.snippet.getcountermodel.kt";
import CounterFragment from "!!raw-loader!@site/docs/generated/java/sync/counter_fragment.xml";
import Binding from "!!raw-loader!@site/docs/generated/java/sync/CounterFragment.snippet.binding.kt";
import OnActive from "!!raw-loader!@site/docs/generated/java/sync/LiveRealmObject.snippet.onactive.kt";
