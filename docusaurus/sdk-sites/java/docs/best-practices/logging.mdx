...
import SetKotlin from "!!raw-loader!@site/docs/generated/java/sync/SyncDataTest.snippet.set-client-log-level.kt";
import SetJava from "!!raw-loader!@site/docs/generated/java/sync/SyncDataTest.snippet.set-client-log-level.java";
