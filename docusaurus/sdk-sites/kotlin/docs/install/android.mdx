...
dependencies {
    ...
    // highlight-next-line
    compileOnly 'io.realm.kotlin:library-base:${variables.kotlin_sdk_version}'
...
- Add `io.realm.kotlin` to the list of plugins, specifying
  the library version and `apply false`.
- Add `io.realm.kotlin:library-base` to the list of dependencies with
  the `compileOnly` keyword.
- To use coroutines with the SDK, add
  `org.jetbrains.kotlinx:kotlinx-coroutines-core`
  to the list of dependencies.
...
dependencies {
    ...
    implementation 'org.jetbrains.kotlinx:kotlinx-coroutines-core:${variables.kotlinx_coroutines_version}'
    // highlight-next-line
    compileOnly 'io.realm.kotlin:library-sync:${variables.kotlin_sdk_version}'
    implementation 'androidx.core:core-ktx:1.7.0'
    implementation 'androidx.appcompat:appcompat:1.4.1'
    implementation 'com.google.android.material:material:1.5.0'
    implementation 'androidx.constraintlayout:constraintlayout:2.1.3'
