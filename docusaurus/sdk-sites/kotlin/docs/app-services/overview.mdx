...
- [Connect to a Realm App](https://www.mongodb.com/docs/realm/sdk/kotlin/app-services/connect-to-a-realm-app/)
- [Register Users](https://www.mongodb.com/docs/realm/sdk/kotlin/app-services/register-users/)
- [Authenticate Users](https://www.mongodb.com/docs/realm/sdk/kotlin/app-services/authenticate-users/)

## The Realm App Client

To connect to your Realm backend, start with an
[`App`](https://www.mongodb.com/docs/realm-sdks/kotlin/latest/library-sync/-realm%20-kotlin%20-multiplatform%20-s-d-k%20-%20-sync/io.realm.mongodb/-app/index.html)
object.
