...
application, see [Install Realm for Flutter](/sdk/flutter/install) to add the Flutter SDK dependency and then check out
the [Quick Start](/sdk/flutter/quick-start).
...
[Learn how to set up Realm in your Dart project.](/sdk/flutter/install#dart-standalone-installation)
