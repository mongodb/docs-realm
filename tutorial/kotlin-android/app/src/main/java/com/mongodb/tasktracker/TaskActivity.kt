...
class TaskActivity : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        if (user == null) {
            ...
            // :snippet-start: set-up-project-realm
            // :state-start: final
    ...
    // :snippet-start: on-stop-close-realm
    // :state-start: final
    override fun onStop() {
        super.onStop()
        user.run {
        ...
        fab.setOnClickListener {
            ...
            dialogBuilder.setMessage("Enter task name:")
                ...
                .setPositiveButton("Create") { dialog, _ -> run {
                    dialog.dismiss()
                    // :snippet-start: add-new-task-to-project
                    // :state-start: final
    ...
    // :snippet-start: on-destroy-close-realm
    // :state-start: final
    ...
    private fun setUpRecyclerView(realm: Realm, user: User?, partition: String) {
        ...
        // :snippet-start: fetch-tasks-for-project-sorted-by-id
        // :state-start: final
