...
- Atlas Device Sync: Add client reset warnings to pages that mention terminating sync
...
- Atlas Device Sync/Define Data Access Patterns/Flexible Sync: Add section for reserved field names
- Users & Authentication
...
- Update Jest configuration to make tested code examples work with Atlas Device Sync
- Query MongoDB: new section with use cases for querying MongoDB remotely
