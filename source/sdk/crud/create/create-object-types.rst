.. _sdks-create-specific-object-types:
...
.. meta::
   :description: Learn how to create specific types of objects with Atlas Device SDK, including constraints for certain object types.
...
create an object, refer to :ref:`sdks-create-object-methods`.
...
:ref:`sdks-create-specific-property-types`.

Create Specific SDK Object Types
--------------------------------

Before you can create a new object and persist it to the database, you must 
:ref:`sdks-object-models`. Then, include that object type in your database
...
.. _sdks-create-geospatial-data:

Create a Geospatial Data Object
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

After you :ref:`define a geospatial object type <sdks-define-geospatial-object>`,
you can use that type to create objects that persist geospatial data.

Initialize objects that use the geospatial data class, and add them to the
database like you would any other object type.
...
.. tabs-drivers::
   ...
   .. tab::
      ...
      .. include:: /includes/api-details/cpp/crud/create-geospatial-object-not-supported.rst
   ...
   .. tab::
      ...
      .. include:: /includes/api-details/java/crud/create-geospatial-object-not-supported.rst
   ...
   .. tab::
      ...
      .. include:: /includes/api-details/generic/crud/create-geospatial-object-js-ts-description.rst
...
.. include:: /includes/sdk-examples/crud/create-geospatial-data-object.rst
...
.. include:: /includes/sdk-examples/crud/create-geospatial-data-model.rst
