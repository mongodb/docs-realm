realm.write(() => {
  ...
  const drew = realm.create("Person", { id: 1234, name: "Drew" }, "updateMode");
  ...
  // "updateMode", will only update properties where the value has
  // changed, decreasing notifications and improving server-side
  // performance
  const andy = realm.create("Person", { id: 1234, name: "Andy" }, "updateMode");
});
